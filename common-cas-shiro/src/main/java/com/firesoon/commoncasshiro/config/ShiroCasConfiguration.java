package com.firesoon.commoncasshiro.config;

import com.firesoon.commoncasshiro.config.filter.SkyLogoutFilter;
import com.firesoon.commoncasshiro.config.filter.UserFilter;
import com.firesoon.commoncasshiro.config.realm.MyShiroCasRealm;
...
//        filterChainDefinitionMap.put("/webjars/**", "anon");//anon 可以理解为不拦截
        ...
        filterChainDefinitionMap.put("/webservice/**", "user");
