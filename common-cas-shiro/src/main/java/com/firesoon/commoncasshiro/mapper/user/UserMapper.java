package com.firesoon.commoncasshiro.mapper.user;

import com.firesoon.commoncasshiro.mapper.base.Base2Mapper;
 ...
 */
@Mapper
public interface UserMapper extends Base2Mapper<User> {
