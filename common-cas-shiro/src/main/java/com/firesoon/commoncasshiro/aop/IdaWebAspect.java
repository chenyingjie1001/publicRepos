package com.firesoon.commoncasshiro.aop;
...
@Aspect
@Component
public class IdaWebAspect {

    @Pointcut("@within(com.firesoon.commoncasshiro.aop.annotation.IdaPointcut) || @annotation(com.firesoon.commoncasshiro.aop.annotation.IdaPointcut)")
        ...
        try {
            ...
            for (Object arg : args) {
                if (arg instanceof Map) {
                    ...
                    //添加user_organ到参数中
                    map.put("user_organ", user.getUser_organ());
                }
            }
